...
<div id="modalForm" class="modal" style="display: <?= $showModal ? 'flex' : 'none' ?>;">
    <div class="modal-content">
        ...
        <h3><?= $showEditModal ? 'Edit jabatan' : 'Tambah jabatan' ?></h3>
        <form method="post">
...
/* Penyesuaian alert success di mode gelap */
...
.form-group label { color: var(--text-main); display: block; margin-bottom: 5px; }
.form-group input { 
    width: 100%; 
    padding: 10px; 
    border: 1px solid var(--input-border); 
...
.btn-cancel { background: var(--border-color); color: var(--text-body); border: none; padding: 8px 20px; border-radius: 30px; cursor: pointer; }
