...
$data = $cuti->getAll(); // method getAllData harus ditambahkan di class Cuti
...
if ($dataUsaha) {
    ...
    $pdf->SetFont('Arial', 'B', 14);
    $pdf->Cell(0, 8, 'LAPORAN CUTI PEGAWAI', 0, 1, 'C');
    $pdf->Ln(5);
}

$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(0, 8, 'LAPORAN CUTI PEGAWAI', 0, 1, 'L');
$pdf->SetFont('Arial', '', 10);
...
$pdf->Cell(30, 7, 'ID Cuti', 1);
$pdf->Cell(50, 7, 'Pegawai', 1);
$pdf->Cell(30, 7, 'Tgl Mulai', 1);
$pdf->Cell(30, 7, 'Tgl Selesai', 1);
$pdf->Cell(25, 7, 'Hari', 1);
$pdf->Cell(60, 7, 'Alasan', 1);
