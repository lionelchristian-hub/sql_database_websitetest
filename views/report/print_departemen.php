...
$data = $departemen->getAllData($search);
...
if ($dataUsaha) {
    ...
    $pdf->SetFont('Arial', 'B', 14);
    $pdf->Cell(0, 8, 'LAPORAN DATA DEPARTEMEN', 0, 1, 'C');
    $pdf->Ln(5);
}

// Judul laporan
$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(0, 8, 'LAPORAN DATA DEPARTEMEN', 0, 1, 'L');
$pdf->SetFont('Arial', '', 10);
...
$pdf->Cell(45, 8, 'Kode Departemen', 1);
$pdf->Cell(100, 8, 'Nama Departemen', 1);
