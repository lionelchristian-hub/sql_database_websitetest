...
$cuti = new Cuti();
$totalData = $cuti->getTotalCount($search);
...
$data = $cuti->getData($search, $sort, $order, $limitValue, $offset);
            ...
            <tbody>
                <?php if (count($data) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <?php if ($row['status'] == 'pending'): ?>
                                <button class="btn-status" data-id="<?= $row['id_cuti'] ?>" data-status="disetujui" title="Setujui"><i class="fas fa-check-circle" style="color:#2ecc71;"></i></button>
                                <button class="btn-status" data-id="<?= $row['id_cuti'] ?>" data-status="ditolak" title="Tolak"><i class="fas fa-times-circle" style="color:#e74c3c;"></i></button>
                            <?php endif; ?>
                            <a href="#" class="btn-delete" data-id="<?= $row['id_cuti'] ?>" title="Hapus"><i class="fas fa-trash-alt" style="color:#e74c3c;"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                <?php else: ?>
